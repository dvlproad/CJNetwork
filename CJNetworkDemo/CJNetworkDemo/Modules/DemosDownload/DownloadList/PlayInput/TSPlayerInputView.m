...
@implementation TSPlayerInputView
...
- (void)setupViews {
    ...
    self.textField.font = [UIFont systemFontOfSize:12];
    self.textField.contentScaleFactor = 0.5;
    self.textField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:NSLocalizedStringFromTable(@"请输入要播放的视频链接...", @"LocalizableDownloader", nil) attributes:@{NSForegroundColorAttributeName: [UIColor darkGrayColor]}];
    self.textField.layer.cornerRadius = 10;
    self.textField.layer.masksToBounds = YES;
...
//    iconView.contentMode = UIViewContentModeScaleAspectFit;
    ...
    */
    ...
    [self.fetchButton setTitle:NSLocalizedStringFromTable(@"播放", @"LocalizableDownloader", nil) forState:UIControlStateNormal];

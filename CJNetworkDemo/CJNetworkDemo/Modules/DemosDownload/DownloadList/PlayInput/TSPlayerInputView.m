...
- (void)setupViews {
    ...
    self.textField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入要播放的视频链接..." attributes:@{NSForegroundColorAttributeName: [UIColor darkGrayColor]}];
...
//    iconView.contentMode = UIViewContentModeScaleAspectFit;
    ...
    [self.fetchButton setTitle:@"播放" forState:UIControlStateNormal];

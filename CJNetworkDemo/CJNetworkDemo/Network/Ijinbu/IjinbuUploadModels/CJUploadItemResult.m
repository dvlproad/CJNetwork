...
#import "CJUploadItemResult.h"

@implementation CJUploadItemResult
...
+ (NSString *)jsonArrayWithObjectArray:(NSArray<CJUploadItemResult *> *)jsonArray
{
    NSMutableArray * temp = [NSMutableArray arrayWithCapacity:jsonArray.count];
    for (CJUploadItemResult *uploadItemResult in jsonArray) {

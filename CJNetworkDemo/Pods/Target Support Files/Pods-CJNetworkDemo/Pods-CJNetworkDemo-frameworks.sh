...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CJBlankPresenter/CJBlankPresenter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJContainer/CJContainer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJMediaCacheKit/CJMediaCacheKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJMediaPlayer/CJMediaPlayer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJMonitor/CJMonitor.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJNetwork-Swift/CJNetwork_Swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJNetwork/CJNetwork.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJNetworkClient/CJNetworkClient.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJNetworkFileModel/CJNetworkFileModel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJNetworkSimulate/CJNetworkSimulate.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJOverlayView/CJOverlayView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJPlayer/CJPlayer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJPopupAction/CJPopupAction.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJPopupContainer/CJPopupContainer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CQDemoNetworkClient/CQDemoNetworkClient.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CQDemoResource/CQDemoResource.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CQMdeiaVideoFrameKit/CQMdeiaVideoFrameKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CQVideoUrlAnalyze-Swift/CQVideoUrlAnalyze_Swift.framework"

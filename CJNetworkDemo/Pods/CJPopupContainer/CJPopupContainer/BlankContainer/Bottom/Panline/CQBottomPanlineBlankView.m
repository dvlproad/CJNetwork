...
+ (CJBottomBlankView *)blankViewFromCustomViewWithoutPanline:(UIView *)customViewWithoutPanline {
    for (UIView *superview = customViewWithoutPanline.superview;
         superview != nil;
         superview = superview.superview) {
        if ([superview isKindOfClass:[CQBottomPanlineBlankView class]]) {
            return (CQBottomPanlineBlankView *)superview;
        }
    }
    return nil;
}
                           ...
                           cornerViewPart:(CQBottomBlankAndPanlinePopupPart)cornerViewPart
{
    ...
    if (effectViewPart == CQBottomBlankAndPanlinePopupPartBlankView) {
        ...
        [popupView effectWithViewPart:CQPanlinePopupViewPartNone effectStyle:CQEffectStyleNone];
    }
    ...
    if (cornerViewPart == CQBottomBlankAndPanlinePopupPartPopupViewWithoutPanLine) {
        ...
        [popupView cornerWithViewPart:CQPanlinePopupViewPartNone cornerRadius:0];
    }
}

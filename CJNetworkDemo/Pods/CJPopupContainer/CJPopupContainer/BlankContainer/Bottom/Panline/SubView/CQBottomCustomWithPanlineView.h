...
//
//  作为 CQBottomPanlineBlankView 初始化方法中的 popupView 参数，层级关系：
//
//  CQBottomPanlineBlankView          ← blankView（背景遮罩 + 点击消失 + 拖拽关闭）
//    └── CQBottomCustomWithPanlineView  ← 本类：popupView（组装 customView + 下拉线）

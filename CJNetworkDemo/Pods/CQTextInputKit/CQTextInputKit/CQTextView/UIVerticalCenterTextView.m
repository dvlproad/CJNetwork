...
@interface UIVerticalCenterTextView () <UITextViewDelegate> {
...
- (void)uiTextView_adjustedContentInsetToTextCenter:(CGFloat)delay {
    [self cj_adjustedContentInsetToTextCenter:delay verticalAlignment:CJVerticalAlignmentCenterByOne];
}



#pragma mark - Setter
- (void)setShouldChangeCheckBlock:(BOOL (^)(NSString * _Nonnull))shouldChangeCheckBlock {
    _shouldChangeCheckBlock = shouldChangeCheckBlock;
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text {
    ...
    if (self.shouldChangeCheckBlock) {
